# Generated by Powerlevel10k configuration wizard on 2020-05-30 at 17:01 CEST.
...
() {
  ...
  #typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\uF126 ' handled in materials

  # Untracked files icon. It's really a question mark, your font isn't broken.
  # Change the value of this parameter to show a different icon.
  #typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='?' handled in materials file
